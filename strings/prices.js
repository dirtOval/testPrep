...
// take a float and return (IN STRING FORMAT) the amount formatting in dollars and cents.
...
//return '$' + num to fixed 2 to string

const prices = num => '$' + num.toFixed(2).toString();
